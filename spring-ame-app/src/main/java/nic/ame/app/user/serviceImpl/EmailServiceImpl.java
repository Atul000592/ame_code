...
public class EmailServiceImpl {
	...
	public static boolean sendEmail(String subject, String content) {
		return sendEmail("atul29030@gmail.com", null, subject, content, null, null, null);
	}

	// Email with attachment to multiple id in to and cc
	public static boolean sendEmail(String subject, String content, String attachmentFileName,
			InputStream attachmentFileStream, String attachmentContentType) {
		return sendEmail("atul29030@gmail.com", null, subject, content, attachmentFileName, attachmentFileStream,
				attachmentContentType);
	}

	// Email with attachment to single recipient and optional cc addresses
	public static boolean sendEmail(String subject, String content, List<String> ccAddresses, String attachmentFileName,
			InputStream attachmentFileStream, String attachmentContentType) {
		return sendEmail("atul29030@gmail.com", ccAddresses, subject, content, attachmentFileName, attachmentFileStream,
				attachmentContentType);
	}
