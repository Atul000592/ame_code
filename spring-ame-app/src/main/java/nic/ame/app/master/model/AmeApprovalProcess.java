...
@Entity
@Table(name = "tt_ame_approval_process")
public class AmeApprovalProcess {
	...
	@Override
		public String toString() {
			return "AmeApprovalProcess [id=" + id + ", ameId=" + ameId + ", boardId=" + boardId + ", receiverRoleCode="
					+ receiverRoleCode + ", senderRoleCode=" + senderRoleCode + ", senderRemark=" + senderRemark
					+ ", createdOn=" + createdOn + ", isActiveStatus=" + isActiveStatus + ", createdBy=" + createdBy
					+ ", isEsignStatus=" + isEsignStatus + ", ameApprovalStatus=" + ameApprovalStatus + "]";
		}
