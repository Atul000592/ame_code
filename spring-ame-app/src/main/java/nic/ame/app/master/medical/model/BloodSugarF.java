...
@Entity
@Table(name="tt_blood_sugar_f")
public class BloodSugarF {
	@Id
	...
	public String toString() {
		return "BloodSugarF [ameId=" + ameId + ", bloodSugarF=" + bloodSugarF + ", testCode=" + testCode + ", path="
				+ path + ", fileName=" + fileName + ", fileType=" + fileType + ", fileSize=" + fileSize
				+ ", lastModifiedOn=" + lastModifiedOn + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedFrom="
				+ lastModifiedFrom + "]";
	}
