...
//=================medical role table==========================//
	...
	public String getUriForApplicationUnderProcess(int id) throws Exception {
	    ...
	    if (roleCode.equalsIgnoreCase("mb1") || roleCode.equalsIgnoreCase("mb2")) {
	        roleCode = "bm";
	    }
	    ...
	    if (roleCode.equalsIgnoreCase("AA")) {
	        uriCode = MapUriToUser.getUriForApplicationUnderProcess(roleCode);
	    } else {
	        uriCode = MapUriToUser.getUriForApplicationUnderProcess(roleCode);
	    }

	    String uri = ameParametersRepository.getAmeParameterValue(uriCode);
